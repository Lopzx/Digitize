    ...
    <div class="flex flex-col tablet:gap-8 gap-4 justify-center items-center bg-white laptop:h-[75vh] h-[85vh] laptop:w-fit w-full rounded-3xl tablet:px-12 px-6 py-8 tablet:my-16 my-8">
        <div>
            <form action="{{route('search1')}}" method="GET" class="input-group row">
                        <select type="text" name="cari" name="category">
        ...
        <div class="flex justify-center gap-4">
            <button class="bg-gradient rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 p-[2px]">
        ...
        <div class="flex justify-center">
            <a href="{{ route('getCreatePage')}}"><button id="add-btn" class="bg-gradient text-center tablet:text-xl text-base text-white font-semibold py-1 px-16 rounded-lg">Add Participant</button></a>
        </div>
    </div>
</section>
